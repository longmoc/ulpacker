      ...
      <div className="day-note">
        <textarea
          ...
          placeholder={
            ...
            "> quotes, --- dividers, [links](https://example.com)\n" +
...
export default function ItineraryDays({
  ...
  const dayStart = (d) => (d.startBoundary === "start" ? startName || "Start" : d.startName || "Start");
  const dayEnd = (d) => (d.endBoundary === "finish" ? finishName || "Finish" : d.endName || "Finish");
